...
\end{example}
\begin{example}
Invariant measures are crucial in the study of the long term behavior of stochastic differential
systems. We invite the reader to refer to \cite{MR838085} for an overview of the subject. However, in many cases there is no explicit formula for the invariant measures.  Let \((X_t)_{t\in [0,T]}\) be the unique strong solution to the  SDE
\begin{eqnarray*}
dX_t=b(X_t)\,dt+\sigma(X_t)\,dW_t
\end{eqnarray*}
starting at \(X_0\) where \(W\) is a standard \(\mathbb{R}^m\)-valued Brownian motion.
\end{example}
