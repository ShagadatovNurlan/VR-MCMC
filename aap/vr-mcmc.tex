...
\includegraphics[width=0.4\textwidth]{pictures/GM_2d_violin_cv_zv.png}
\label{fig:subfig1}}
\qquad
\subfloat[Subfigure 2 list of figures text][d = 8]{
\includegraphics[width=0.4\textwidth]{pictures/GM_8d_violin_cv_zv.png}
\label{fig:subfig2}}
\caption{Gaussian mixture violins (cvB1 - algorithm 1, cvB2 - algorithm 2, ZV, CV) \label{fig:1}}
\end{figure}
