...
Such  situation arises, for example, in the case of functionals of the discretized diffusion processes. In this case a Wiener chaos-type decomposition can be used to construct control variates with nice properties, see \cite{belomestny2018stratified}.   
